...
REMAP_DECIMATE =16    # downscaling factor for remapping image 缩小比例以重新映射图像
...
TEXT_MAX_THICKNESS =60 # max reduced px thickness of detected text contour检测到的文字轮廓最大减少的px厚度
...
EDGE_MAX_ANGLE =240  # maximum change in angle allowed between contours轮廓之间允许的最大角度变化
...
# 宽度
SPAN_PX_PER_STEP =40  # reduced px spacing for sampling along spans 减少px间距以进行跨距采样
...
if __name__ == '__main__':
    ...
    #         exit(0)
    img = cv2.imread(r'D:\pycharm\work\page_dewrap\page_dewarp-master\example_input\TEST\test1.jpg')
