...
def pnm_to_svg(figure, **kwargs):

    potrace_path = kwargs.get('potrace', r"E:\potrace-1.16.win64\potrace.exe")
    pnm_filepath = figure
    subprocess.call([potrace_path, pnm_filepath, '-s','--flat'])
